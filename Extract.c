 ...
 * contents of Extract.xs. Do not edit this file, edit Extract.xs instead.
 *
...
XS(XS_String__Comments__Extract__slash_star_extract_comments); /* prototype to pass -Wmissing-prototypes */
XS(XS_String__Comments__Extract__slash_star_extract_comments)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: String::Comments::Extract::_slash_star_extract_comments(string)");
    {
	SV*	string = ST(0);
	SV *	RETVAL;
#line 430 "Extract.xs"
...
extern "C"
#endif
XS(boot_String__Comments__Extract); /* prototype to pass -Wmissing-prototypes */
XS(boot_String__Comments__Extract)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("String::Comments::Extract::_slash_star_extract_comments", XS_String__Comments__Extract__slash_star_extract_comments, file);
    XSRETURN_YES;
}
